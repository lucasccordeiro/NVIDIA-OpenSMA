...
SOURCES += \
	...
	$(PATH_SDK_DEVICE)/system_MCXN556S_cm33_core0.c \
	$(PATH_SDK_DEVICE)/gcc/startup_MCXN556S_cm33_core0.S \
...
SYSTEM_INCLUDES +=  \
	...
	$(PATH_SDK)/middleware/multicore/mcmgr/inc/ \
	$(PATH_SDK)/middleware/multicore/mcmgr/inc/platform/mcxnx4x/ \
