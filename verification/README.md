...
| [#4201](https://github.com/esbmc/esbmc/issues/4201) | open ([#4203](https://github.com/esbmc/esbmc/pull/4203) reverted by [#4208](https://github.com/esbmc/esbmc/pull/4208) — skip too broad) | spi_utils harness parenthesises cast inside shift |
