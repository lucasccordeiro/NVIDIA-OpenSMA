...
\subtitle{A formal-verification finding in NVIDIA OpenSMA, confirmed and fixed upstream}
...
\begin{frame}{Executive summary}
  \begin{block}{In one paragraph}
    ...
    \hil{confirmed and fixed upstream by NVIDIA}).
...
\end{itemize}
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{block}{Trigger}
        ...
        \hil{confirmed and fixed by NVIDIA} (2026-05-11) --- the bound
        check is now mirrored into \texttt{set\_cur\_eid()} as recommended.
      \end{block}
    \end{column}
  \end{columns}
\end{frame}
    ...
    \begin{column}{0.52\textwidth}
      ...
      \begin{itemize}\setlength\itemsep{0.05em}
        ...
        \item \bad{Confirmed reachable (3):}
              ...
              (\href{https://github.com/NVIDIA/OpenSMA/issues/1}{\hil{NVIDIA/OpenSMA\#1}}
              --- \hil{confirmed and fixed upstream by NVIDIA, 2026-05-11});
  ...
  \begin{block}{}
    ...
    \begin{enumerate}
      \item Formal verification \hil{produced a counterexample for a real
            ...
            had missed --- \hil{confirmed and fixed upstream by NVIDIA}
            (\href{https://github.com/NVIDIA/OpenSMA/issues/1}{NVIDIA/OpenSMA\#1}).
